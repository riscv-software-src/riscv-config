...
This doc is meant to serve as a quick-guide to setup RISCV-CONFIG and perform \
sample validation  of RISC-V privileged and unprivileged ISA Spec. The validation will 
result in  generation of the standard specification yaml file.

Install Python Dependencies
===========================

RISCV-CONFIG requires `pip` and `python` (>=3.7) to be available on your system. If you have issues, instead of installing either of these directly on your system, we suggest using a virtual environment
